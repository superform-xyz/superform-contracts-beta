...
describe("strategies base tests:", async () => {
  ...
  async function deployStrategy(
    ...
    await TokenImpersonated.transfer(accounts[0].address, MilionTokensE18);
  ...
  describe("CompoundV2 ETH Mainnet Vault base tests:", async () => {
    before("deploy CompoundV2 ETH Mainnet Wrapper", async function () {
      accounts = await ethers.getSigners();

      // const USDC_whale = "0xee5b5b923ffce93a870b3104b7ca09c3db80047a";
      ...
      const DAI_wahle = "0xc08a8a9f809107c5a7be6d90e315e4012c99f39a";
      await deployStrategy(
        "CompoundV2StrategyWrapper",
        ForkConfig.COMPOUND_ETH_COMPOUND.DAI,
        ForkConfig.COMPOUND_ETH_COMPOUND.COMP,
        ForkConfig.COMPOUND_ETH_COMPOUND.cDAI,
        ForkConfig.COMPOUND_ETH_COMPOUND.Comptroller,
        DAI_wahle,
      );
    ...
    it("CompoundV2Wrapper ETH MAINNET: user DEPOSIT to CompoundV2Wrapper", async function () {
    ...
    it("CompoundV2Wrapper ETH MAINNET: user REDEEM from CompoundV2Wrapper", async function () {
        const vaultId = 1;
